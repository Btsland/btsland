...
public class transaction {
    ...
    public required_authorities get_required_authorities() {
        ...
        for (info.btsland.app.api.operations.operation_type operationType : operations) {
            info.btsland.app.api.operations.base_operation baseOperation = (info.btsland.app.api.operations.base_operation) operationType.operationContent;
